...
def train(training_config):
    ...
    for epoch in range(training_config['num_of_epochs']):
        for batch_id, (content_batch, _) in enumerate(train_loader):
            ...
            # Save content loss
            content_losses_dict[epoch] = content_loss
            with open('losses/content_losses_dict.pickle', 'wb') as handle:
                pickle.dump(content_losses_dict, handle, protocol = pickle.HIGHEST_PROTOCOL)
            ...
            # Save style loss
            style_losses_dict[epoch] = content_loss
            with open('losses/style_losses_dict.pickle', 'wb') as handle:
                pickle.dump(style_losses_dict, handle, protocol = pickle.HIGHEST_PROTOCOL)
            ...
            # Save total loss
            total_losses_dict[epoch] = content_loss
            with open('losses/total_losses_dict.pickle', 'wb') as handle:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--console_log_freq", type=int, help="logging to output console (batch) frequency", default=630)
    ...
    # print(training_config['dataset_path'])
