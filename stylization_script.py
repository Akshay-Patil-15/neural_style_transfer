...
if __name__ == "__main__":
    ...
    parser.add_argument("--content_input", type=str, help="Content image(s) to stylize", default='horse_rider.jpg')
    ...
    parser.add_argument("--model_name", type=str, help="Model binary to use for stylization", default='style_edtaonisl_datapoints_10162_cw_1.0_sw_400000.0_tw_0.pth')
